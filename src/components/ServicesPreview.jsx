...
const services = [
  {
    title: "Microneedling",
    description:
      "Vivez une relaxation profonde avec nos soins de microneedling, idéaux pour améliorer la texture et l'éclat de votre peau.",
    image:
  ...
  },
  {
    ...
    description:
      "Revitalisez votre peau avec notre soin royal, utilisant des ingrédients naturels pour une expérience luxueuse et réparatrice.",
    image:
  ...
  },
  {
    ...
    description:
      "Ravivez l'éclat naturel de votre sourire grâce à notre traitement de blanchiment dentaire professionnel et sécurisé.",
    image:
